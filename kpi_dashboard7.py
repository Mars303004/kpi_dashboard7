...
df["Trend Insight"] = df.apply(generate_trend_insight, axis=1)
...
display_cols = ['Kode KPI', 'KPI', 'Target Tahunan', 'Actual Jan', 'Target Feb', 'Actual Feb',
                'Measurement Type', 'Status', 'Trend Insight']
